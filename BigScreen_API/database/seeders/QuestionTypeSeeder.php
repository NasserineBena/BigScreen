...
class QuestionTypeSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        QuestionType::create(['question'=>'Votre sexe','response_possibility'=>json_encode(['Homme', 'Femme', 'Préfère ne pas répondre'], JSON_UNESCAPED_UNICODE),'type'=>'A']);
        ...
        QuestionType::create(['question'=>'Quel marque de casque VR utilisez-vous ?','response_possibility'=>json_encode(['Oculus Quest', 'Oculus Rift/s', 'HTC Vive', 'Windows Mixed Reality', 'Valve index'], JSON_UNESCAPED_UNICODE),'type'=>'A']);
        QuestionType::create(['question'=>'Sur quel magasin d’application achetez vous des contenus VR ?','response_possibility'=>json_encode(['SteamVR', 'Occulus store', 'Viveport', 'Windows store'], JSON_UNESCAPED_UNICODE),'type'=>'A']);
        QuestionType::create(['question'=>'Quel casque envisagez-vous d’acheter dans un futur proche ?','response_possibility'=>json_encode(['Occulus Quest', 'Occulus Go', 'HTC Vive Pro', 'PSVR', 'Autre','Aucun'], JSON_UNESCAPED_UNICODE),'type'=>'A']);
        ...
        'jouer en solo', 'jouer en équipe'], JSON_UNESCAPED_UNICODE),'type'=>'A']);
