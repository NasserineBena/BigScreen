...
<template>
  <header>
    ...
    <div>
      ...
      <p class="buttonAuth" v-if="connexion == true" v-on:click.prevent="logout"> Déconnexion</p>
      <p  class="buttonAuth" v-if="connexion == false" v-on:click.prevent="login"> Connexion</p>
    </div>
